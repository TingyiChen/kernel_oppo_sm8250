...
#ifdef VENDOR_EDIT
//Juqiang.Geng@MULTIMEDIA.AUDIODRIVER.FEATURE, 2020/05/16, Add for speaker mute
...
/*Wei.Hua@MULTIMEDIA.AUDIODRIVER.SMARTPA, 2020/07/03, Add to get latest calibration*/
