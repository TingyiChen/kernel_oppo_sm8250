...
int set_oppo_display_vendor(const char * display_name) {
	if (display_name == NULL)
		return -1;
	if (!strcmp(display_name,"qcom,mdss_dsi_oppo19065_samsung_1440_3168_dsc_cmd")) {
		oppo_display_vendor = OPPO_SAMSUNG_ANA6706_DISPLAY_FHD_DSC_CMD_PANEL;
		register_device_proc("lcd", "ANA6706", "samsung1024");
	} else if (!strcmp(display_name,"qcom,mdss_dsi_samsung_oneplus_dsc_cmd")) {
		oppo_display_vendor = OPPO_SAMSUNG_ONEPLUS_DISPLAY_FHD_DSC_CMD_PANEL;
