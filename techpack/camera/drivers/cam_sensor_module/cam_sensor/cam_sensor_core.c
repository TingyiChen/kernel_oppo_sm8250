...
#define SEM1815S_FW_UPDATE_NAME				 "sem1215s_19066_dvt.bin"
...
static int cam_sem1815s_ois_fw_download(struct cam_sensor_ctrl_t *o_ctrl)
{
	...
	if (data == ois_fw_version || data == SEM1815S_SEC_FW_UPDATE_VERSION) {
...
#define LASER_ENABLE_PATH  "/sys/class/input/input5/enable_ps_sensor"
#define LASER_CROSSTALK_ENABLE "/sys/class/input/input5/crosstalk_enable"
#define LASER_CORRECTION_MODE  "/sys/class/input/input5/smudge_correction_mode"
