...
#define SUPPORT_WPC
//#define WPC_USE_SP6001
#ifdef WPC_USE_SP6001
#define SUPPORT_SP6001_FW_UPDATE
#endif
...
WPC_CHG_STATUS_WAITING_CEP_ZERO,
};
...
#define P9221_CMD_GET_HW_VERSION							0xAC
#define P9221_CMD_SET_PWM_PULSE								0xAD
...
#define P9237_RESPONE_READY_FOR_EPP							0xF7
...
#define P9237_RESPONE_HW_VERSION							0xFC
#define P9221_RESPONE_PWM_PULSE								0xFD
...
#define WPC_CHARGE_FFC_TEMP_MAX								400

#define WPC_FASTCHG_TEMP_MIN								120
...
#define WPC_TERMINATION_CURRENT								300
...
struct wpc_data{
	...
	int					fastchg_current_max;
	int					fastchg_current_min;
	int					fastchg_current;
